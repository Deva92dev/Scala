...
export async function SettingsContent({ userId, orgId, role }: Props) {
          ...
          <div>
            ...
            <div className="flex -space-x-2 overflow-hidden">
              ...
              {teamMembers.length >= 5 && (
                <div className="flex items-center justify-center h-8 w-8 rounded-full border-2 border-background bg-muted text-[10px] font-medium text-foreground">
                  +more
                </div>
              )}
            </div>
